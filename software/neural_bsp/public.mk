...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../neural_soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is neural_soc
SOPC_NAME := neural_soc
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1480977927
SOPC_SYSID_FLAG += --timestamp=1480977927
ELF_PATCH_FLAG  += --timestamp 1480977927
